...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header ">
        <a href="/test" class="navbar-brand ">衣+ 搜索测试</a>
    </div>
    <ul class="nav nav-pills">
        <li><a href="/index/youku">算法测试</a></li>
        <li><a href="/index/youkuOld">算法测试_颜色特征</a></li>
        <li><a href="/index/category">判断分类</a></li>
        <li><a href="/index/test">3C/商超/日用品/家具</a></li>
        <li><a href="/object/detect">物体识别qtype=12</a></li>
        <li><a href="/object/tags">物体标签qtype=13</a></li>
        <li><a href="/face/index">人脸识别</a></li>
        <li><a href="/face/compare">人脸对比</a></li>
        <li><a href="/star/pk">PK明星衣品qtype=13</a></li>
        <li><a href="/star/detect">明星识别qtype=14</a></li>
    </ul>
</nav>
