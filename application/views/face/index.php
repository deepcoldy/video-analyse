...
<div class='range_div'>
    ...
    <div class='range_p'>
        ...
        <p class='range_p1'>准确识别出照片中的人物的性别、年龄、种族、表情、颜值等属性。平均准确率超过90%。 可以广泛用于视频中人脸检测、娱乐化相机等多种场景。</p>
    </div>
</div>
</div>
    ...
    <div class='result_p'>
        ...
        <div class="result-area" style="margin-left: 20px;">
            ...
            <ul class="nav nav-tabs nav-pills" role="tablist">
                <li role="presentation" ng-repeat="face in faces" ng-class="{'active': ($index==0)}" style="margin-bottom: 5px;"><a href="#content{{$index}}" role="tab" data-toggle="tab" style="padding: 0px 8px;">{{$index}}</a></li>
            </ul>

            <!-- Tab panes -->
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane" ng-class="{'active': ($index==0)}" id="content{{$index}}" ng-repeat="face in faces">
                    <p style="margin-bottom: 3px;">颜值：{{face.beauty}}</p>
                    <p style="margin-bottom: 3px;">性别：{{face.gender}}</p>
                    <p style="margin-bottom: 3px;">种族：{{face.race}}</p>
                    <p style="margin-bottom: 3px;">微笑指数：{{face.smile}}</p>
                    <p style="margin-bottom: 3px;">年龄：{{face.age}}</p>
                    <p style="margin-bottom: 3px;">表情：{{face.expression}}</p>
                </div>
            </div>
